...
class JwtHelperTest {
    ...
    void testGenerateAccessToken() {
        String accessToken = jwtHelper.generateAccessToken(TEST_USERNAME);
    ...
    void testGenerateRefreshToken() {
        String refreshToken = jwtHelper.generateRefreshToken(TEST_USERNAME);
    ...
    void testValidateToken_ExpiredToken() throws InterruptedException {
        ...
        String shortLivedToken = jwtHelper.generateAccessToken(TEST_USERNAME);
